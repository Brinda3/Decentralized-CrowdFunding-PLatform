    ...
    PausableUpgradeable 
{
    ...
    error PAYOUTDEPOSITCOUNTEXCEEDED(uint256 maxCount, uint256 currentCount);
    ...
    */
    ...
    function initialize(Structs.deployParams memory params) initializer public {
        ...
        MATURITY_INTEREST_PERMILE = params.capitalAppreciationPermile;
        PAYOUT_TYPE = params._payoutType;
        TOTAL_PAYOUTS = params.maxDividendsCount;
    }
    ...
    */
        ...
        returns (bool)
    {
        ...
        if (feedCount + 1 > TOTAL_PAYOUTS) {
            revert PAYOUTDEPOSITCOUNTEXCEEDED(TOTAL_PAYOUTS, feedCount + 1);
        }
