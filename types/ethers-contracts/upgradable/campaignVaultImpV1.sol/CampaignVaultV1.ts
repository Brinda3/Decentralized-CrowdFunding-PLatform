...
export declare namespace CampaignVaultV1 {
    ...
    export type UserDetailStruct = {investments: CampaignVaultV1.InvestmentDetailStruct[], totalAllocatedShares: BigNumberish, lastclaimedIndex: BigNumberish, lastclaimTimestamp: BigNumberish}

    export type UserDetailStructOutput = [investments: CampaignVaultV1.InvestmentDetailStructOutput[], totalAllocatedShares: bigint, lastclaimedIndex: bigint, lastclaimTimestamp: bigint] & {investments: CampaignVaultV1.InvestmentDetailStructOutput[], totalAllocatedShares: bigint, lastclaimedIndex: bigint, lastclaimTimestamp: bigint }
  
    }

export declare namespace Structs {
      
    export type DeployParamsStruct = {admin: AddressLike, signer: AddressLike, _name: string, _symbol: string, asset: AddressLike, goal: BigNumberish, _minInvestment: BigNumberish, _maxInvestment: BigNumberish, _startTime: BigNumberish, _endTime: BigNumberish, _tokenPrice: BigNumberish, _payoutType: BigNumberish, maturityTime: BigNumberish, interestPermile: BigNumberish, maxdividendPayouts: BigNumberish}

    export type DeployParamsStructOutput = [admin: string, signer: string, _name: string, _symbol: string, asset: string, goal: bigint, _minInvestment: bigint, _maxInvestment: bigint, _startTime: bigint, _endTime: bigint, _tokenPrice: bigint, _payoutType: bigint, maturityTime: bigint, interestPermile: bigint, maxdividendPayouts: bigint] & {admin: string, signer: string, _name: string, _symbol: string, asset: string, goal: bigint, _minInvestment: bigint, _maxInvestment: bigint, _startTime: bigint, _endTime: bigint, _tokenPrice: bigint, _payoutType: bigint, maturityTime: bigint, interestPermile: bigint, maxdividendPayouts: bigint }
  
    }

  export interface CampaignVaultV1Interface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "DEPOSIT_FEE_PERMILE" | "ENDTIME" | "FUNDING_CAP" | "MATURITY_INTEREST_PERMILE" | "MATURITY_TIME" | "MAX_DEPOSIT" | "MIN_DEPOSIT" | "PAYOUT_TYPE" | "STARTTIME" | "TOKEN_PRICE" | "TOTAL_INVESTMENTS" | "TOTAL_PAYOUTS" | "WITHDRAW_FEE_PERMILE" | "admin" | "allowance" | "approve" | "asset" | "balanceOf" | "claim" | "convertToAssets" | "convertToShares" | "decimals" | "deposit" | "depositWithSign" | "feedFunds" | "getROI" | "getRoleAdmin" | "getTotalPayouts" | "getUserDetails" | "getmaturityROI" | "grantRole" | "hasRole" | "initialize" | "maxDeposit" | "maxMint" | "maxRedeem" | "maxWithdraw" | "mint" | "name" | "pause" | "paused" | "previewDeposit" | "previewMint" | "previewRedeem" | "previewWithdraw" | "redeem" | "renounceRole" | "rescueTokens" | "revokeRole" | "signAuthority" | "supportsInterface" | "symbol" | "totalAssets" | "totalSupply" | "transfer" | "transferFrom" | "transferOwnership" | "unpause" | "withdraw" | "withdrawFunds"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "Deposit" | "FUNDSAdded" | "Initialized" | "OwnerChanged" | "Paused" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "Transfer" | "Unpaused" | "Withdraw" | "withdrawnFunds"): EventFragment;
...
encodeFunctionData(functionFragment: 'TOTAL_PAYOUTS', values?: undefined): string;
...
encodeFunctionData(functionFragment: 'depositWithSign', values: [BigNumberish, CampaignVaultV1.SignStruct]): string;
...
encodeFunctionData(functionFragment: 'getTotalPayouts', values?: undefined): string;
...
encodeFunctionData(functionFragment: 'initialize', values: [Structs.DeployParamsStruct]): string;
...
decodeFunctionResult(functionFragment: 'TOTAL_PAYOUTS', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'getTotalPayouts', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'withdrawFunds', data: BytesLike): Result;
  ...
  export interface CampaignVaultV1 extends BaseContract {
    
    connect(runner?: ContractRunner | null): CampaignVaultV1;
    waitForDeployment(): Promise<this>;

    interface: CampaignVaultV1Interface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    TOTAL_PAYOUTS: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    depositWithSign: TypedContractMethod<
      [assets: BigNumberish, sign: CampaignVaultV1.SignStruct, ],
      [bigint],
      'nonpayable'
    >
    ...
    getTotalPayouts: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    getUserDetails: TypedContractMethod<
      [user: AddressLike, ],
      [CampaignVaultV1.UserDetailStructOutput],
      'view'
    >
...
getFunction(nameOrSignature: 'TOTAL_INVESTMENTS'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'TOTAL_PAYOUTS'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
...
getFunction(nameOrSignature: 'getRoleAdmin'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getTotalPayouts'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
